...
# setwd("/Users/work/Documents/Programmes/R/hybridRNAsim")
...
# example run (two hybrids)
x <- runsims(iterations, n.genes, scalar, bio.reps, significance, fold.change, o.n.diffexp, o.seqdepth, 
	o.fraction.upregulated, h1.n.diffexp, h1.seqdepth, h1.fraction.upregulated, second.hybrid, h2.n.diffexp, h2.seqdepth, h2.fraction.upregulated)

expression.res <- rbind(expression.res, x)
expression.res

# appended example run (two hybrids)
x <- runsims(iterations, n.genes, scalar, bio.reps, significance, fold.change, o.n.diffexp, o.seqdepth, 
	o.fraction.upregulated, h1.n.diffexp, h1.seqdepth, h1.fraction.upregulated, second.hybrid, h2.n.diffexp, h2.seqdepth, h2.fraction.upregulated)
